...
const Dashboard = () => {
    const { totalHours, totalCourses, totalCompletedCourses } = useAppContext()
    return (
        <div className="dashboard">
            ...
            <div className="status-cards">
                <StatusCard title="Total Hours" value={totalHours} icon={<Clock color="purple" background="purple" />} />
